...
WebUI.click(findTestObject('Object Repository/QA01/input_INQUIRY_calbtn'))

'previous year'
WebUI.click(findTestObject('Object Repository/QA01/div_INQUIRY_calendar-nav calendar-prevyear _176344'))
...
'field filter'
WebUI.click(findTestObject('Object Repository/QA01/div_FIELD'))
